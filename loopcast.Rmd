...
#trying to fit models with watay too much data
mods<-c("beta_reg","narx1","arimax1","ets1","tbats1") %>% enframe() %>% mutate(data=rep(list(d2),nrow(.))) %>% mutate(train=rep(list(d2[d2$date<"2018-10-10" & d2$date>"2017-10-09",]))) %>% mutate(test=rep(list(d2[d2$date<"2019-10-3" & d2$date>"2018-10-10",])))
...
beta_reg<-mods$train[[1]] %>% beta_reg()
