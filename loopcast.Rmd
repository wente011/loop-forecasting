...
mods<-c("beta_reg","narx1","arimax1","ets1","tbats1") %>% enframe() %>% mutate(data=rep(list(d2),nrow(.))) %>% mutate(train=rep(list(d2[d2$date>"2019-06-01" & d2$date<"2019-08-30",]))) %>% mutate(test=rep(list(d2[ d2$date>"2019-08-30",])))
